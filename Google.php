...
<html lang="en">
  <head>
    ...
    <!-- Author of Document -->
    <meta name="author" content="Sania Saeed @ Codify Academy">
    <!-- Title -->
    <title>GBoy</title>
    <!-- Font Awesome -->
  ...
  <body>
    ...
    <ul class="top-navigation">
      <li>
        <a href="https://www.google.com/">Abdullah Kazmi</a>
      </li>
      <li>
      ...
      <li>
        <img class="profile-img" src="Gboy icon.png">
      </li>
    </ul>
    <!-- Middle Section - Search Box -->
    <div class="search-box">
      <img src="google real.png" title="If Google Had A Boy">
      <form action="Connection.php" method="post">
      <input name=text id=text type="text" autofocus placeholder="Search Google or type a URL">
      <input name=button type="submit">Search</input>
        </form>
    </div>
